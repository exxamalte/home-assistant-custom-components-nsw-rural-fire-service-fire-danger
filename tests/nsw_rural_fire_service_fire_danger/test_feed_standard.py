...
@pytest.mark.asyncio
async def test_feed_standard(hass: HomeAssistant, mock_aioresponse, config_entry):
...
@pytest.mark.asyncio
async def test_feed_standard_act(hass: HomeAssistant, mock_aioresponse, config_entry):
    """Test standard feed setup and entities."""
    await async_setup_component(hass, "homeassistant", {})
    mock_aioresponse.get(
        "http://www.rfs.nsw.gov.au/feeds/fdrToban.xml",
